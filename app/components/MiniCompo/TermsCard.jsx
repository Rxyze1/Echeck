...
export const TermsCard = () => {
    ...
    const handleGoogleSignIn = async (response) => {
        try {
            ...
            setMessage('❌ Error decoding email');
        }
    };
                        ...
                        <>
                            ...
                            <div className="flex gap-3">
                                <button
                                    ...
                                    className="flex-1 px-4 py-2.5 sm:py-3 rounded-xl font-bold text-sm sm:text-base bg-zinc-800/60 border border-zinc-700/60 text-gray-300 hover:bg-zinc-700/60 hover:border-red-900/40 transition-all duration-300 backdrop-blur-md shadow-lg hover:shadow-red-900/20"
                                >
                                    Reject
                                </button>
                                <button
                                    onClick={handleAccept}
                                    className="flex-1 px-4 py-2.5 sm:py-3 rounded-xl font-bold text-sm sm:text-base bg-gradient-to-r from-red-600 to-red-500 text-white hover:from-red-500 hover:to-red-400 transition-all duration-300 shadow-lg shadow-red-600/40 hover:shadow-red-500/60 active:scale-95"
                                >
                                    Accept
                                </button>
                            </div>
                        ...
                        <>
                            ...
                            <div className="mb-6 flex justify-center">
                                <div 
                                    ...
                                    className="w-full [&>div]:!flex [&>div]:!justify-center"
                                />
                            </div>
